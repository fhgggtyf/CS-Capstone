...
print("Starting ACU data extraction...")
...
cursor.execute('''
    CREATE TABLE IF NOT EXISTS ACU_steam (
...
gz_path = "Data_Extraction/Database/289650_ASSASINS_CREED_UNITY/289650_ASSASINS_CREED_UNITY_english_reviews_19700101-000000_20250714-093214.jsonl.gz"
batch_size = 10000
batch = []
inserted_total = 0
...
with gzip.open(gz_path, "rt", encoding="utf-8") as f:
    for i, line in enumerate(f, 1):
        ...
        if i % batch_size == 0:
            cursor.executemany('''
                INSERT OR REPLACE INTO ACU_steam (
